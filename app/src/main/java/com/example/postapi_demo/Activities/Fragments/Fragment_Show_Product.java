...
public class Fragment_Show_Product extends Fragment {
    ...
    public static Fragment_Show_Product newInstance(String param1, String param2) {
        Fragment_Show_Product fragment = new Fragment_Show_Product();
